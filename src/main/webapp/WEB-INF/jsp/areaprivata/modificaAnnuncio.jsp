...
<main role="main" class="container">
    ...
    <spring:hasBindErrors name="dettaglio_articolo_attr">
        <%-- alert errori --%>
    ...
    <div class='card'>
        ...
        <div class='card-body'>
            ...
            <form:form modelAttribute="dettaglio_articolo_attr" method="post" action="updateAnnuncio"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <spring:bind path="testoAnnuncio">
                            <input type="text" name="testoAnnuncio" id="testoAnnuncio"
                                   ...
                                   placeholder="Inserire il testoAnnuncio" value="${dettaglio_articolo_attr.testoAnnuncio }" required>
                        </spring:bind>
                        ...
                        <spring:bind path="id">
                            <input type="hidden" name="id" id="id"
                                   class="form-control ${status.error ? 'is-invalid' : ''}"
                                   value="${dettaglio_articolo_attr.id }" required>
                        </spring:bind>
                    </div>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <spring:bind path="prezzo">
                            <input type="text" class="form-control ${status.error ? 'is-invalid' : ''}"
                                   ...
                                   value="${dettaglio_articolo_attr.prezzo }" required>
                        </spring:bind>
