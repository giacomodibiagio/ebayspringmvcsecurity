	  ...
	  <div class="container">
	    ...
	    <div class="row">
	      <div class="col-md-6">
	        ...
	        <p>Questa funzione riguarda la gestione dei registi</p>
	        
	        <p><a class="btn btn-primary" href="regista/search" role="button">Vai alla funzione &raquo;</a></p>
	      </div>
	      <div class="col-md-6">
	        <h2>Gestione film</h2>
	        <p>Questa funzione riguarda la gestione dei film</p>
	        <p><a class="btn btn-primary" href="film/search" role="button">Vai alla funzione &raquo;</a></p>
	      </div>
	    </div>
